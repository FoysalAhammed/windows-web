...
import profile from "../../poortfolio.png"
import Resume from "../../Resume_foysal.pdf"
...
const AboutMe = ({ page, handleDivClick, expandedDiv }) => {
  const renderPageContent = () => {
    switch (page) {
      case "About Me":
        return (
          <div className="hero min-h-auto justify-start">
            <div className="hero-content pt-5 flex-col lg:flex-row">
              <img
                src={profile}
                className="max-w-sm rounded-lg shadow-2xl h-80 w-80"
                alt="Profile"
              />
              <div>
      ...
      case "Resume":
        return (
            <iframe className="h-full w-full" src={Resume} title="Foysal Ahammed resume" frameBorder="0"></iframe>
        );
      default:
